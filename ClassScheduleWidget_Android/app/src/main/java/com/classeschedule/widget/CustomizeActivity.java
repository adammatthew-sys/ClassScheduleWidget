...
public class CustomizeActivity extends Activity {
    ...
    private static final int CROP_IMAGE = 42;
    ...
    public void onCreate(Bundle b) {
        ...
        findViewById(R.id.backgroundColorButton)
                .setOnClickListener(v -> chooseColor(true));

        findViewById(R.id.textColorButton)
                .setOnClickListener(v -> chooseColor(false));

        findViewById(R.id.cornerButton)
                .setOnClickListener(v -> chooseRadius());

        findViewById(R.id.imageButton)
                .setOnClickListener(v -> pickImage());

        findViewById(R.id.clearImageButton)
        ...
        findViewById(R.id.saveButton)
                .setOnClickListener(v -> saveAndExit());
    ...
    private void updatePreview() {
        ...
        pLabel.setTextColor(c);
        pSubject.setTextColor(c);
        pTime.setTextColor(c);
        pRoom.setTextColor(c);
        pTeacher.setTextColor(c);
...
if (bgUri.startsWith("content://")) {
    ...
    private void saveAndExit() {
        ...
        ScheduleWidgetProvider.refreshAll(
                this
        );
